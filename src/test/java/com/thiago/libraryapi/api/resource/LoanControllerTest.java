...
import com.thiago.libraryapi.api.dto.ReturnedLoanDTO;
...
import com.thiago.libraryapi.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void invelidIsbnCreateLoanTest() throws Exception {
    ...
    public void loanedBookErrorOnCreateLoanTest() throws Exception {
        ...
        BDDMockito.given( loanService.save(Mockito.any(Loan.class)) )
                .willThrow(new BusinessExcepition("Book already loaned"));
    ...
    public void findLoansTest() throws Exception {
        ...
        BDDMockito.given(
                loanService.find(Mockito.any(LoanFilterDTO.class), Mockito.any(Pageable.class))
        ).willReturn(
                new PageImpl<Loan>(Arrays.asList(loan), PageRequest.of(0, 10), 1)
        );
