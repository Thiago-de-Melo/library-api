...
public class BookControllerTest {
    ...
    @Test
    @DisplayName("Deve lançar erro ao tentar cadastrar um livro com isbn já utilisado por outro")
    public void createBookWithDuplicatedIsbn() throws Exception {
        ...
        BDDMockito.given(service.save(Mockito.any(Book.class)))
                .willThrow(new BusinessExcepition(mensagemErro));
    ...
    @Test
    @DisplayName("Deve atualiar um livro")
    public void updateBookTest() throws Exception {
        ...
        Book updatedBook = Book.builder()
                .id(id).author("Artur").title("As aventuras").isbn("321").build();
    ...
    @Test
    @DisplayName("Deve retornar 404 ao tentar atualiar um livro inexistente")
    public void updateInexistentBookTest() throws Exception {

        String json = new ObjectMapper().writeValueAsString(createNewBook());

        BDDMockito.given( service.getById(BDDMockito.anyLong()) )
    ...
    public void findBookTest() throws Exception {
        ...
        BDDMockito.given(
                service.find(Mockito.any(Book.class), Mockito.any(Pageable.class))
        ).willReturn(
