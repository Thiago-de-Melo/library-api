...
public interface LoanRepository extends JpaRepository<Loan, Long> {
    ...
    @Query(value = "select l from Loan l where l.loanDate <= :theeDaysAgo and ( l.returned is null or l.returned is false )")
    List<Loan> findByLoanDateLessThanAndNotReturned(@Param("theeDaysAgo") LocalDate theeDaysAgo);
}
